...
const questions = [
  ...
  { text: "소중한 사람과의 관계에서는 갈등을 회피하지 않고 해결하려 한다.", weights: { G: 1, T: 1 } },
  { text: "평소에는 다정하지만, 신뢰를 깨뜨리면 강하게 반발한다.", weights: { G: 1, T: 1 } },
  { text: "갈등을 피하고 싶지만, 관계가 소중하면 붙잡으려 노력한다.", weights: { G: 1, A: 1 } },
  { text: "거절하지 못하고 받아주다가, 결국 지쳐 혼자 거리를 둔다.", weights: { G: 1, A: 1 } },
  { text: "겉으로는 잘 맞춰주지만, 속으로는 혼자 감정을 삼킬 때가 많다.", weights: { G: 1, A: 1 } },
  { text: "불편한 기분을 표현하게 만드는 상대방이 잘못되었다고 생각한다.", weights: { T: 1, A: 1 } },
  { text: "불편한 만남이나 상황은 단칼에 거절할 수 있다.", weights: { A: 2 } },
